...
public class Rows extends org.zkoss.gwt.client.zul.Widget{
	...
	}-*/; //I:/svn/zk5_sf/zul/src/archive/web/js/zul/grid/Rows.js line:[34]
	
	public native org.zkoss.gwt.client.zul.grid.Grid getGrid()/*-{
		var widget = this.@org.zkoss.gwt.client.zk.Widget::getZkWidget()();
		return widget.getGrid();
	}-*/; //I:/svn/zk5_sf/zul/src/archive/web/js/zul/grid/Rows.js line:[39]
	
	public native int getGroupCount()/*-{
		var widget = this.@org.zkoss.gwt.client.zk.Widget::getZkWidget()();
		return widget.getGroupCount();
	}-*/; //I:/svn/zk5_sf/zul/src/archive/web/js/zul/grid/Rows.js line:[45]
	
	public native Widget[] getGroups()/*-{
		var widget = this.@org.zkoss.gwt.client.zk.Widget::getZkWidget()();
		return widget.getGroups();
	}-*/; //I:/svn/zk5_sf/zul/src/archive/web/js/zul/grid/Rows.js line:[51]
	
	public native boolean hasGroup()/*-{
		var widget = this.@org.zkoss.gwt.client.zk.Widget::getZkWidget()();
		return widget.hasGroup();
	}-*/; //I:/svn/zk5_sf/zul/src/archive/web/js/zul/grid/Rows.js line:[57]
	
	public native void stripe()/*-{
		var widget = this.@org.zkoss.gwt.client.zk.Widget::getZkWidget()();
		widget.stripe();
	}-*/; //I:/svn/zk5_sf/zul/src/archive/web/js/zul/grid/Rows.js line:[86]
}
