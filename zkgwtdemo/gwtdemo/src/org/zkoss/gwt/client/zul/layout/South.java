...
public class South extends org.zkoss.gwt.client.zul.layout.LayoutRegion{
	...
	}-*/; //I:/svn/zk5_sf/zul/src/archive/web/js/zul/layout/South.js line:[28]
	
	public native void setWidth(String width)/*-{
		var widget = this.@org.zkoss.gwt.client.zk.Widget::getZkWidget()();
		widget.setWidth(width);
	}-*/; //I:/svn/zk5_sf/zul/src/archive/web/js/zul/layout/South.js line:[21]
	
	public native String getSize()/*-{
		var widget = this.@org.zkoss.gwt.client.zk.Widget::getZkWidget()();
		return widget.getSize();
	}-*/; //I:/svn/zk5_sf/zul/src/archive/web/js/zul/layout/South.js line:[35]
	
	public native void setSize(String size)/*-{
		var widget = this.@org.zkoss.gwt.client.zk.Widget::getZkWidget()();
		widget.setSize(size);
	}-*/; //I:/svn/zk5_sf/zul/src/archive/web/js/zul/layout/South.js line:[41]
}
