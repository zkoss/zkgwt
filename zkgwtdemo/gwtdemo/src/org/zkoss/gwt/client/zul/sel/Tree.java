...
public class Tree extends org.zkoss.gwt.client.zul.sel.SelectWidget{
	...
	}-*/; //I:/svn/zk5_sf/zul/src/archive/web/js/zul/sel/Tree.js line:[181]
	
	public native Widget[] getItems()/*-{
		var widget = this.@org.zkoss.gwt.client.zk.Widget::getZkWidget()();
		return widget.getItems();
	}-*/; //I:/svn/zk5_sf/zul/src/archive/web/js/zul/sel/Tree.js line:[204]
	
	public native int getItemCount()/*-{
		var widget = this.@org.zkoss.gwt.client.zk.Widget::getZkWidget()();
		return widget.getItemCount();
	}-*/; //I:/svn/zk5_sf/zul/src/archive/web/js/zul/sel/Tree.js line:[214]
}
